...
// Métodos
    ...
    /**
     * Método validarCep - Validação básica de CEP
     * @param cep String 
     * @return true para Cep válido
     */
    public static boolean validarCep(String cep) {
    	return cep.matches("\\d{5}-\\d{3}");
    }
    /**
     * Método validarTelefone - Validação básica de Telefone
     * @param telefone String 
     * @return true para telefone válido
     */
    ...
    /**
     * Método removerAcentos -  Método básico para removerAcentos
     * @param str String 
     * @return str sem acentos
     */
    ...
    public static String formatarMilisegundos(long miliseg, int retorno) {
		...
		if (retorno==Lib.RETORNAR_SEGUNDOS){
